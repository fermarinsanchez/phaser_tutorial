class MenuScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("menuSelect", "assets/audio_files/menuSelect.wav");
  }

  create() {
    // Fondo negro
    this.add.image(800, 600, "background").setScale(2);
    ...
    const startbuttonSound = this.sound.add("menuSelect", { volume: 0.75 });
